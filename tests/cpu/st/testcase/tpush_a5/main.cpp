...
static __aicore__ void main_incore_0_aic(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4) {
  unsigned v5 = 0;
...
static __aicore__ void main_incore_0_aiv(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4) {
  unsigned v5 = 0;
  __gm__ void * v6 = nullptr;
  const float v7 = 1.0f;
  const int32_t v8 = 8;
